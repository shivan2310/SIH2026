...
export const GATES: Record<GateType, GateDef> = {
  h: {
    ...
    name: "Hadamard",
    description:
      "Creates an equal superposition: |0> -> (|0>+|1>)/sqrt(2). The workhorse of quantum parallelism.",
    targets: 1,
    controls: 0,
    params: [],
    category: "single",
  ...
  x: {
    ...
    label: "X",
    name: "Pauli-X (NOT)",
    description: "Bit flip: swaps |0> and |1>. A pi rotation about the X axis.",
    targets: 1,
    controls: 0,
    params: [],
    category: "single",
  ...
  t: {
    ...
    label: "T",
    name: "T (π/8)",
    description: "Eighth turn about Z: |1> -> e^{ipi/4}|1>.",
    targets: 1,
    controls: 0,
    params: [],
    category: "phase",
